...
import { iocContainer } from './lib/tsyringe_tsoa_ioc_container';
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/movies/find',
            ...
            async function MovieController_getMovies(request: any, response: any, next: any) {
            const args = {
            ...
            try {
                ...
                const controller: any = await container.get<MovieController>(MovieController);
        ...
        app.get('/movies/:id',
            ...
            async function MovieController_getMovie(request: any, response: any, next: any) {
            const args = {
